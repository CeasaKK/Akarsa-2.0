// components/CulturalSidebar.tsx
...
export default function CulturalSidebar() {
  return (
    <aside className="branding-sidebar">
      <h3 className="branding-sidebar-title">All Services</h3>
      <p className="branding-sidebar-sub">Explore what we build for brands</p>

      <ul className="branding-sidebar-list">
        {services.map((s) => {
          const isActive = s.href === "/services/cultural-strategy";
          return (
