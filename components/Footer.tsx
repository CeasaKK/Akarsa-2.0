    ...
    <footer className="footer-section" role="contentinfo">
      <div className="footer-inner">
        ...
        <div className="footer-col footer-brand">
          ...
          <div className="footer-socials" aria-label="Akarsa social links">
            <Link href="https://www.facebook.com/profile.php?id=61577404206425" className="social-btn" aria-label="Facebook">
              {/* facebook svg */}
            ...
            <Link href="https://www.instagram.com/akarsa_studio/" className="social-btn" aria-label="Instagram">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <Link href="https://x.com/AkarsaDyniq" className="social-btn" aria-label="X / Twitter">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <Link href="https://www.instagram.com/akarsa_studio/" className="social-btn" aria-label="YouTube">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <Link href="https://in.pinterest.com/beakarsa/?actingBusinessId=1046594538313121806" className="social-btn" aria-label="Pinterest">
        ...
        <div className="footer-col footer-contact">
          ...
          <div className="footer-addresses">
            <div className="addr">
              <img src="/dubai.png" alt="UAE flag" className="addr-flag" />
              <div>Dubai, United Arab Emirates</div>
            </div>

            <div className="addr">
              <img src="/ind.png" alt="India flag" className="addr-flag" />
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-left">
          <div>© {new Date().getFullYear()} Akarsa Studio Pvt Limited. All Rights Reserved.</div>
          <div>Created with ❤️ by Akarsa Team</div>
        </div>
